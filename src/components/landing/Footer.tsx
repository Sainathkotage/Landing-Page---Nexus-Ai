  ...
  const cols = [
    {
      ...
      links: [
        ...
        { label: 'Integrations', href: '/nexus-ai/integrations' },
        { label: 'WebLabs', href: '/weblabs' },
        { label: 'Roadmap', href: '/nexus-ai/roadmap' },
      ],
    },
    {
      title: 'Use Cases',
      links: [
        { label: 'For Startups', href: '/nexus-ai/for-startups' },
        { label: 'For Founders', href: '/nexus-ai/for-founders' },
        { label: 'For Operations', href: '/nexus-ai/for-operations' },
        { label: 'For Remote Teams', href: '/nexus-ai/for-remote-teams' },
        { label: 'Technology Teams', href: '/nexus-ai/industries/technology' },
      ],
    },
    {
      title: 'Resources',
      links: [
        ...
        { label: 'Quick Start', href: '/help/getting-started/quick-start' },
        { label: 'Documentation', href: '/nexus-ai/docs' },
        { label: 'Blog Articles', href: '/blog' },
        { label: 'Common Issues', href: '/help/troubleshooting/common-issues' },
      ],
    },
    {
      title: 'Company & Legal',
      links: [
        ...
        { label: 'Security & Trust', href: '/help/account/security' },
